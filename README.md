...
| Plugin | What it does |
| :--- | :--- |
| `hello-world` | Confirms your setup is working. Install this first to check that the marketplace is registered and plugins load. |
...
/plugin install hello-world@machinemetrics
```
...
Some skills are invoked deliberately instead. Skills are prefixed with the plugin name,
so `hello-world` provides one you run yourself:

```
/hello-world:hello
```

Run it after installing to confirm your setup works.
...
```
claude plugin details hello-world@machinemetrics
```
...
```
/plugin list
/plugin disable hello-world@machinemetrics
/plugin uninstall hello-world@machinemetrics
```
...
Email [support@machinemetrics.com](mailto:support@machinemetrics.com) or open an issue in
this repository.
